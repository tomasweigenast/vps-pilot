...
const navItems = [
  ...
  { to: "/events",        label: "Events",        icon: Zap,            permission: "view_events" },
  { to: "/cron",          label: "Cron Jobs",     icon: Clock,          permission: "view_cron" },
  { to: "/notifications", label: "Notifications", icon: Bell,           permission: "view_notifications" },
  { to: "/secrets",       label: "Secrets",       icon: LockKeyhole,    permission: "view_secrets" },
  { to: "/registries",    label: "Registries",    icon: KeyRound,       permission: "view_registries" },
  { to: "/backup",        label: "Backup",        icon: DatabaseBackup, permission: "manage_backups" },
